...
public class InstantiateSpectrogram : MonoBehaviour
{
    ...
    public void Enable(TextMeshProUGUI text)
    {
        ...
        ReloadSpectrogramSettings.instance.UpdateHeight(ReloadSpectrogramSettings.instance.height);
        Settings.instance.config.visuals.spectrogram.enable3d = enableShells;
    }
