...
public class BeatNumbers : MonoBehaviour
{
    ...
    {
        if (SpawnObjects.instance.PositionFromBeat(beat) < SpawnObjects.instance.PositionFromBeat(SpawnObjects.instance.BeatFromRealTime(LoadSong.instance.audioSource.clip.length)))
        {
